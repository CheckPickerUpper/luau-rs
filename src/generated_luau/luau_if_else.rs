...
impl LuauIfElse {
    ...
    pub(crate) fn condition(&self) -> &LuauExpression {
        &self.condition
    }

    /// Supplies statements emitted for the true branch.
    pub(crate) fn then_body(&self) -> &LuauFunctionBody {
        &self.then_body
    }

    /// Supplies statements emitted for the false branch.
    pub(crate) fn else_body(&self) -> &LuauFunctionBody {
        &self.else_body
    }
}
